...
light_agent = ChatCompletionAgent(
    ...
    instructions="Handle light control requests. If the user ask your name, tell them you're mahendra.  When using any tools, plugins, or transferring to other agents, let me know what you're doing explicitly.",
